...
// Destructor
///////////////////////// TO-DO (7) //////////////////////////////
GroceryItem::~GroceryItem() = default;
/////////////////////// END-TO-DO (7) ////////////////////////////
...
///////////////////////// TO-DO (8) //////////////////////////////
std::string const& GroceryItem::upcCode() const& { return _upcCode; }
/////////////////////// END-TO-DO (8) ////////////////////////////
...
///////////////////////// TO-DO (10) //////////////////////////////
std::string const& GroceryItem::productName() const& { return _productName; }
/////////////////////// END-TO-DO (10) ////////////////////////////
...
std::string upcCode, brandName, productName;
  double price;
  stream >> std::ws >> std::quoted(upcCode) >> std::ws >> std::quoted(brandName) >> std::ws >> std::quoted(productName) >> std::ws >> price;
  if (stream) {
...
std::ostream & operator<<( std::ostream & stream, const GroceryItem & groceryItem )
{
  ...
  //        written, if desired.
  ///////////////////////// TO-DO (22) //////////////////////////////
stream << std::quoted(groceryItem.upcCode()) << ", " << std::quoted(groceryItem.brandName()) << ", " << std::quoted(groceryItem.productName()) << ", " << std::format("{:.2f}", groceryItem.price());
  return stream;
  /////////////////////// END-TO-DO (22) ////////////////////////////
}
